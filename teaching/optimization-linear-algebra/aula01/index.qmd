...
2. **Seleção dos Vizinhos:** Identifica-se o conjunto $\mathcal{N}_k(\mathbf{x}_{\text{novo}}) \subset \mathcal{D}$ composto pelas $k$ amostras com as menores distâncias até \mathbf{x}_{\text{novo}}. A predição para regressão é dada pela média:
